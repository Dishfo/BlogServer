...
function showUserInfo() {
	...
	$.ajax({
		...
		success : function(response) {
			var headurl=response.userHeadUrl===undefined?" ":response.userHeadUrl;
			var nickname=response.userNickName===undefined?" ":response.userNickName;
			var phone=response.userPhone===undefined?"":response.userPhone;
			var age=response.userAge===undefined?"":response.userAge;
			var address=response.userAddress===undefined?"":response.userAddress;
			$('#mainWindow').html('');
			$('#mainWindow')
					.append(

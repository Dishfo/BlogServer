...
function loadSimpleCode(codeData){
	$('#latestCode').append('<div class="col-md-3 col-sm-6 col-padding article-box-div" >'
			...
			+ '<div class="desc">'
			+ '<h3 class="article-title"><a href="/code/codelib/' + codeData.codeId + '">' + codeData.codeTitle + '</a></h3>'
			+ '<span class="article-author">'+ '作者:'+ codeData.codeAuthor.userName +'&nbsp;'
			...
			+ '<a href="/code/codelib/' + codeData.codeId + '" class="lead read-more" >阅读更多 <i class="glyphicon glyphicon-arrow-right"></i></a>'
			+ '</div>'
			+ '</div>');
}